<?php 
    ...
    if (isset($_POST['edit'])){
    	...
    	?><script type="text/javascript">location.href = 'all_product.php';</script><?php
	}
	        ...
	        <nav class="navbar-default navbar-side" role="navigation">
	            <div class="sidebar-collapse">
	                <ul class="nav" id="main-menu">
	                    ...
	                    <li>
	                        <a href="edit_product.php" class="active-menu waves-effect waves-dark"><i class="fa fa-edit"></i> Edit Product</a>
	                    </li>
	                    <li>
                        	...
                        	<div class="card-content"><br>
                        		<form action="" method="POST" enctype="multipart/form-data">
									...
									<div class="input-field col s12">
									  <input id="product_name" placeholder="Product name" name="product_name" value="<?php echo $row['name']; ?>" type="text" class="validate" required>
									</div>
									</div>

									<div class="row">
									<div class="input-field col s12">
									   <textarea id="textarea" placeholder="Product description" name="description" class="validate materialize-textarea" required><?php echo $row['description']; ?></textarea>
									</div>
									</div>

									<div class="row">
									<div class="input-field col s12">
									  <input id="price" name="price" placeholder="Price" type="text" value="<?php echo $row['price']; ?>" class="validate" required>
									</div>
									</div><br>
									...
									<div class="row">
									<div class="input-field col s12">
									  <button type="submit" name="edit" class="waves-effect waves-light btn">Edit Product</button>
									</div>
									</div>
								</form>
							</div>
